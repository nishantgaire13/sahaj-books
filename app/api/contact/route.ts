...
export async function POST(request: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: "nishantamish@gmail.com",
      replyTo: email,
      subject: `New enquiry from ${name} — SahajBooks`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #f5f5f0; padding: 32px; border-radius: 12px;">
          ...
          <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #e8e8e4;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 13px; color: #aaa;">Phone</td><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 14px; font-weight: 600; color: #111;">${country} ${phone || "—"}</td></tr>
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 13px; color: #aaa;">Address</td><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 14px; color: #111;">${address || "—"}</td></tr>
              <tr><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 13px; color: #aaa;">Service</td><td style="padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 14px; color: #111;">${service || "—"}</td></tr>
