  ...
  <rect width="100%" height="100%" fill="url(#dots)">
    ...
    />
      ...
      <div style={{
        ...
        >
          {/* Whole dashboard floats up and down */}
          <motion.div
            animate={{ y: [0, -12, 0] }}
                ...
                <div style={{ width: "152px", background: "#142e14", padding: "14px 0", flexShrink: 0 }}>
                  ...
                  {["Overview", "Bookkeeping", "VAT Returns", "Payroll", "Tax Returns", "Reports"].map((item, i) => (
                    <div key={item} style={{
                      ...
                      color: i === 0 ? "#6abf47" : "rgba(255,255,255,0.3)",
                      background: i === 0 ? "rgba(106,191,71,0.08)" : "transparent",
                      borderLeft: `2px solid ${i === 0 ? "#6abf47" : "transparent"}`,
                    }}>
                      {item}
                    </div>
                  ))}
                    ...
                    <div style={{ display: "flex", alignItems: "flex-end", gap: "3px", height: "48px" }}>
                      {[45, 58, 40, 72, 55, 65, 88, 78, 60, 95, 82, 100].map((h, i) => (
                        <div key={i} style={{
                          ...
                          height: `${h}%`,
                          background: h > 80 ? "#6abf47" : h > 60 ? "#a8d990" : "#e8e8e4",
                        }} />
                      ))}
                    </div>
                  </div>
