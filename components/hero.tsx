  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Mobile — service highlights grid */}
        {isMobile && (
          <motion.div
            ...
            {[
              {
                ...
                icon: (
                  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="#6abf47" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="5" y="2" width="10" height="16" rx="2"/><line x1="8" y1="7" x2="12" y2="7"/><line x1="8" y1="10" x2="12" y2="10"/>
                  </svg>
                ),
              },
              {
                label: "VAT Returns",
                status: "MTD compliant",
                icon: (
                  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="#6abf47" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="4" y="4" width="12" height="12" rx="1"/><line x1="7" y1="8" x2="13" y2="8"/><line x1="7" y1="11" x2="13" y2="11"/>
                  </svg>
                ),
              },
              {
                ...
                icon: (
                  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="#6abf47" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 14l4-6 4 4 3-5 3 3"/><line x1="3" y1="17" x2="17" y2="17"/>
                  </svg>
                ),
              },
              {
                label: "Corporation Tax",
                status: "CT600 handled",
                icon: (
                  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="#6abf47" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              >
                ...
                <div style={{ fontSize: "12px", fontWeight: 700, color: "rgba(255,255,255,0.85)", lineHeight: 1.3, marginBottom: "6px" }}>{card.label}</div>
                <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                  <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: "#6abf47", flexShrink: 0 }} />
                  <span style={{ fontSize: "10px", fontWeight: 600, color: "#6abf47" }}>{card.status}</span>
                </div>
              </div>
            ))}
          </motion.div>
