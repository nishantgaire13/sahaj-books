  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Mobile — simple stat cards instead of complex dashboard */}
        {isMobile && (
          <motion.div
          ...
          >
            {[
              { label: "VAT Return", value: "£4,280", status: "Filed", icon: "📋" },
              { label: "Compliance", value: "98.6%", status: "Up to date", icon: "✅" },
              { label: "Payroll Nov", value: "£13,479", status: "RTI Sent", icon: "💼" },
              { label: "CT600", value: "On time", status: "Filed", icon: "📊" },
            ].map((card) => (
              <div
                key={card.label}
                style={{
              ...
              >
                ...
                <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "4px" }}>{card.label}</div>
                <div style={{ fontSize: "16px", fontWeight: 700, color: "white", marginBottom: "4px" }}>{card.value}</div>
                <div style={{ fontSize: "11px", fontWeight: 700, color: "#6abf47" }}>{card.status}</div>
              </div>
            ))}
          </motion.div>
        )}
